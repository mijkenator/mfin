...
def main(args):
    ...
    subprocess.run("cp photolib/test/2F1A4BAD-74FF-47EC-A9E9-DADF73ABCD22.heic photolib/new/", capture_output=True, text=True, shell=True)
    subprocess.run("cp photolib/test/82F5F9F0-1807-4B22-ACB0-3F8A0FABE3A7.heic photolib/new/", capture_output=True, text=True, shell=True)
    subprocess.run("cp photolib/test/65235203-ADA0-4F82-B1B1-7E4907B2C184.heic photolib/new/", capture_output=True, text=True, shell=True)
